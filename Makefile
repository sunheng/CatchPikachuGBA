...
OFILES = main.o font.o mylib.o text.o pokemonLogo.o pikachuKO.o pokeball.o meowth.o pikachu.o happyPikachu.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h pokemonLogo.h pikachuKO.h pokeball.h meowth.h pikachu.h happyPikachu.h
